...
.Lox用の機能拡張をインストールした
image::lox-language-plugin-installed.png[{full-width}]

.実行した結果のスナップの例
image::lox-language-plugin-installed-exsample.png[{full-width}]
...
.Git Bashの動作を確認した
image::git-bash-installed.png[{full-width}]

.実行した結果のスナップの例
image::git-bash-installed-exsample.png[{full-width}]
...
.JDKのインストールを確認した
image::jdk-installed.png[{full-width}]

.実行した結果のスナップの例
image::jdk-installed-example.png[{full-width}]
...
image::git-clone-result.png[{full-width}]

.実行した結果のスナップの例
image::git-clone-result-example.png[{full-width}]
...
image::readme-adoc-console-result.png[{full-width}]

.実行した結果のスナップの例
image::readme-adoc-console-result-example.png[{full-width}]
...
image::readme-adoc-chrome-result.png[{full-width}]

.実行した結果のスナップの例(1)
image::readme-adoc-chrome-result-example01.png[{full-width}]

.実行した結果のスナップの例(2)
image::readme-adoc-chrome-result-example02.png[{full-width}]
...
image::readme-adoc-vscode-result.png[{full-width}]

.実行した結果のスナップの例
image::readme-adoc-vscode-result-example.png[{full-width}]
...
.jLoxを動かした
image::jlox-orig-run-result.png[{full-width}]
...
image::jlox-orig-aux-run-result.png[{full-width}]
...
image::breakfast-lox-code.png[{full-width}]
...
image::breakfast.png[{full-width}]
...
image::doughnut-lox-code.png[{full-width}]
...
image::doughnut-lox-result.png[{full-width}]
...
.5章の実行結果
image::chap05-result.png[{full-width}]
...
.6章の実行結果
image::chap06-result.png[{full-width}]
...
.7章の実行結果
image::chap07-result.png[{full-width}]
...
.8章の実行結果
image::chap08-result.png[{full-width}]
...
.9章の実行結果
image::chap09-result.png[{full-width}]
...
.Amazonに掲載された書評
image::amazon-review-result.png[{full-width}]
